...
<div id="localizer"class="localizer">
	<div id="napis" class="okno">Współrzędne geograficzne</div>
	<div id="dlug" class="okno"></div>
	<div id="szer" class="okno"></div>
	...
	<div class="blok1">
		...
		<div class="przerwa"></div>	
			...
			<div class="grupa" >
				...
				<div id="prm_dm_o"   class="ptaszek_ak prm"><input id="wszystkie_dm" type="checkbox" name="checkbox_dm"onclick="przerysuj2('wszystkie_dm','wszystkie_dm')" />Obszar obsługiwany<br/>przez ZDM</div>
					 
				<div  id="prm_rz"  class="ptaszek prm"><input  id="rzeszow" type="checkbox" name="checkbox_dm"onclick="przerysuj2('rzeszow','szary')" />Rzeszów</div>
				<div id="prm_kr"   class="ptaszek prm"><input  id="krosno" type="checkbox" name="checkbox_dm"onclick="przerysuj2('krosno','zolty')" />Krosno</div>
				<div id="prm_pr"   class="ptaszek prm"><input 	id="przemysl" type="checkbox" name="checkbox_dm"onclick="przerysuj2('przemysl','niebieski')" />Przemyśl</div>
				<div  id="prm_sa"  class="ptaszek prm"><input  id="sanok" type="checkbox" name="checkbox_dm"onclick="przerysuj2('sanok','zielone')" />	Sanok</div>
				<div id="prm_mi"   class="ptaszek prm"><input  id="mielec" type="checkbox"name="checkbox_dm" onclick="przerysuj2('mielec','czerwony')" />	Mielec</div>
			</div>
			<div class="przerwa"></div>
			<div class="grupa" >
					...
					<div class="przerwa"></div>	
						<div class="grupa">
							<div id="pt_g" class="ptaszek_ak pt"><input id="granica"name="checkbox_gran" type="checkbox" onclick="przerysuj17('granica','gran')" />Granice	</div>
								...
								<div id="pt_gw"  class="ptaszek pt"><input  id="gran_woj" type="checkbox" name="checkbox_gran"onclick="przerysuj17('gran_woj','gran_woj')" />Województw</div>
								<div id="pt_gp"  class="ptaszek pt"><input  id="gran_pow" type="checkbox" name="checkbox_gran"onclick="przerysuj17('gran_pow','gran_pow')" />Powiatów</div>
